  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        border: Border(
          top: BorderSide(
              color: const Color(0xFF0f380f), width: SCREEN_BORDER_WIDTH),
          left: BorderSide(
              color: const Color(0xFF306230), width: SCREEN_BORDER_WIDTH),
          right: BorderSide(
              color: const Color(0xFF8bac0f), width: SCREEN_BORDER_WIDTH),
          bottom: BorderSide(
              color: const Color(0xFF9bbc0f), width: SCREEN_BORDER_WIDTH),
        ),
      ),
      child: Container(
